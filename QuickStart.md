...
19. In your browser, open the LIQUi|> GitHub site, https://github.com/msr-quarc/Liquid. Click on the "Clone in Desktop" button on the right-hand side of the window. Accept the default file location and any security notifications that open up.  
